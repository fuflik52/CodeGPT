...
namespace Oxide.Plugins
{
    ...
    public class ServerInfoUI : RustPlugin
    {
        ...
        private const float ProgressMinX = 178f;
        private const float ProgressMaxX = 726f;

        [ConsoleCommand("serverinfoui.close")]
        ...
        private void ShowUI(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiButtonComponent { Color = "0 0 0 0.62", Command = "serverinfoui.close" },
            ...
            {
                Button = { Color = "0 0 0 0", Command = "serverinfoui.close" },
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "666 -30.667", OffsetMax = "730.667 -9.333" },
                Text = { Text = "ЗАКРЫТЬ", Align = TextAnchor.MiddleCenter, Color = "0 0 0 1", FontSize = 13, Font = "Roboto-Bold.ttf" }
            });
            ...
            float ratio = Mathf.Clamp01(maxPlayers > 0 ? (float)online / maxPlayers : 0f);

            container.Add(new CuiElement
            {
                Parent = UiName,
                Components = {
                    new CuiImageComponent { Color = "0.7647059 0.7647059 0.7647059 0.53" },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 1",
                        AnchorMax = "0 1",
                        OffsetMin = string.Format("{0} -147.333", ProgressMinX),
                        OffsetMax = string.Format("{0} -132", ProgressMaxX)
                    }
                }
            });

            float fillX = ProgressMinX + (ProgressMaxX - ProgressMinX) * ratio;
            container.Add(new CuiElement
            {
                Parent = UiName,
                Components = {
                    ...
                    new CuiRectTransformComponent
                    {
                        ...
                        AnchorMax = "0 1",
                        OffsetMin = string.Format("{0} -147.333", ProgressMinX),
                        OffsetMax = string.Format("{0} -132", fillX)
                    }
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    {
                        Text = string.Format("\u041e\u043d\u043b\u0430\u0439\u043d: {0}", online),
                        Align = TextAnchor.MiddleCenter,
                        Color = "0.5254902 0.5019608 0.4745098 1",
                        FontSize = 14,
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent
                    {
                        Text = string.Format("\u0417\u0430\u0445\u043e\u0434\u044f\u0442:{0}", joining),
                        Align = TextAnchor.MiddleCenter,
                        Color = "0.5254902 0.5019608 0.4745098 1",
                        FontSize = 14,
                        Font = "Roboto-Bold.ttf"
